...
Il file "result_file.pdf" è il file di merge di ogni file contenuto nella directory "coppie".

il file "test.py" è un esempio di esecuzione della pipeline.

il file "Report_Progetto_ABD_DiGioacchino_Fiusco.pdf" è il report del progetto in formato ".pdf"
